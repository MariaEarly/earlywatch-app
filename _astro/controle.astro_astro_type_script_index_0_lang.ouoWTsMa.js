      ...
      <div class="reminder-body">
        ...
        <div class="reminder-footer">
          ...
          <div class="reminder-actions">
            ${n?`<span style="font-size:12px; color:var(--ew-ink2)">Traite le ${e.done_at?new Date(e.done_at).toLocaleDateString("fr-FR"):""}</span>`:`
