import{A as $,t as v,a as g}from"./api.vBsT2HYn.js";let i=[],d={status:"",domain:""},o=new Set;async function b(){try{const e=await g("/api/v1/my-procedures");if(!e.enabled){document.getElementById("grid").innerHTML=`
