      ...
      <div class="step-item">
        ...
        <div class="step-content">
          ...
          <div class="sit-article-item">
            ...
            <div class="sit-article-meta">${i.source||""}${i.published_at?" · "+new Date(i.published_at).toLocaleDateString("fr-FR"):""} ${(i.common_themes||[]).map(v=>`<span style="font-size:10px;background:var(--ew-surface);color:var(--ew-text-secondary);padding:1px 5px;border-radius:var(--ew-radius-pill);margin-left:4px;border:0.5px solid var(--ew-border-strong);">${v}</span>`).join("")}</div>
          </div>`).join("")}
