import{g as i,l as p,a as c}from"./api.CPWPAWzi.js";function a(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function m(){const e=i()||{};document.getElementById("account-content").innerHTML=`
      ...
      <div class="card" style="padding:24px;margin-bottom:24px">
        ...
        <div id="pwd-success" style="display:none;margin-bottom:12px;padding:12px;background:rgba(92,99,71,0.1);color:#5C6347;border:1px solid #5C6347;font-size:14px"></div>
